...
module.exports = function (app) {
  ...
  plugin.id = 'dynamo-logger'

  // The plugin human readable name
  plugin.name = 'DYNAMO Logger'
          ...
          readStream.on("end", function(){
            ...
            fs.readFile(logDir + "/" + logFile, 'utf8', function(err, data) {
              ...
              try {
                ...
                var srcPem = fs.readFileSync('/Users/raffaelemontella/WebstormProjects/signalk-server-node/keys/src-private.pem');
              ...
              var dstPem = fs.readFileSync('/Users/raffaelemontella/WebstormProjects/signalk-server-node/keys/dst-public.pem');
